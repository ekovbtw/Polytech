...
## Шаг 8
Сделаем прием подтверждения "ok" от сервера при корректном подключении. Сразу после каждой отправки будем ждать "ok", прежде чем идти к следующей строке файла. 
...
В parse_file() добавим в конец вызов функции: 
